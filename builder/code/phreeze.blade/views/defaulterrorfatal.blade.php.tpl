...
<div class="container">
	...
	<!-- ERROR {ldelim}{ldelim} $message {rdelim}{rdelim} /ERROR -->

	<h2><i class="icon-cogs"></i> Oh Snap!</h2>

	<h3 onclick="$('#stacktrace').show('slow');" class="well" style="cursor: pointer;">{ldelim}{ldelim} $message {rdelim}{rdelim}</h3>
	...
	<div id="stacktrace" class="well hide">
		...
		@if (isset($stacktrace))
			<p style="white-space: nowrap; overflow: auto; padding-bottom: 15px; font-family: courier new, courier; font-size: 8pt;">{ldelim}{ldelim} $stacktrace {rdelim}{rdelim}</p>
		@endif
	</div>
